...
Introduction
------------
The backend rest api for my Eezy data website and mobile application
...
* **Abubakar Alaya** - *Maintainer* - `ecode5814@gmail.com <mailto:ecode5814@gmail.com?subject=[GitHub]EezyDataApi>`_
