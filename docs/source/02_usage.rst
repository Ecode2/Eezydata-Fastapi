...
2. Build local development docker image via::
    ...
    $ ./docker-compose.sh build eezydataapi

3. Run the API Service by::

    $ ./docker-compose.sh run --service-ports --rm eezydataapi
...
2. Build local development docker image via::
    ...
    $ ./docker-compose.sh build test_eezydataapi

3. Run the API Service by::

    $ ./docker-compose.sh run test_eezydataapi
